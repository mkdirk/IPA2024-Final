...
ACCESS_TOKEN = f"Bearer {os.environ.get('test_token')}"
...
roomIdToGetMessages = (
    "Y2lzY29zcGFyazovL3VybjpURUFNOnVzLXdlc3QtMl9yL1JPT00vNmRlZjRiMTAtNWU5ZC0xMWVmLTg5ZDktNTFkMjY1ZTc2OGUx"
)
...
# 4. Provide the URL to the Webex Teams messages API, and extract location from the received message.
    ...
    #  e.g.  "/66070123 create"
    if message.startswith("/65070078"):
